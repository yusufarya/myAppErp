		...
		<div class=" ace-save-state">
			<div class="main-content"  style="margin-top: 20px">
				<div class="main-content-inner">
					...
					$qdb = mysql_query("SELECT dbname FROM cust_order WHERE cust_id = $idcust") or die (mysql_error());
					...
					<div align="center"  id="buatdb">
						<form id="judul1">
							<h2 style="color: #294d76"> Hi, <?php echo $_SESSION['custName'];  ?></h3>
							<h3 style="color: #294d76">Selamat Datang di SISCOM Online</h3>
							<a href="#modal-table" role="button" class="btn btn-danger btn-sm btn-sm" data-toggle="modal"> Buat Database </a>
						</form>
					</div>
					<?php 
					} else{
									...
									<div class="widget-body">
										<div class="widget-main">
											<div id="fuelux-wizard-container">
												...
												<div class="step-content pos-rel" id="isiStep">
<!-- step 1 -->
															...
															<div class="container col-xs-12">
																<div class="col-xs-6" style="float: left; padding-left: 10px">
																	...
																	<form>
																		...
																		<input type="text" name="dbname" id="dbname" style="text-transform: lowercase;" placeholder="Nama Alias" maxlength="10" onKeyPress="return goodchars(event, 'abcdefghijklmnopqrstuvwxyz0123456789', this)" onFocus="cari(); selectFocus()" autofocus autocomplete="off" required />
																	</form>
																	<div><br>                                                                                        
																				...
																				<div class="col-xs-12">
																					<div>
																						<label class="line-height-1 blue">
																							<input name="dari" id="agen" value="agen" type="radio" class="detail ace" <?=$selCheckAgent?> />
																							<span class="lbl"> Agen penjualan (Marketing/Agent/Reseller)</span>
																							<br>
																							<div style="padding-left: 20px" >
																								<input style="text-transform: uppercase !important" type="text" id="selectAgen" name="agen" value="<?=$salesid?>" placeholder="Input kode agen" autocomplete="off" onkeyup="cari()" required>
																					...
																					<div>
																						<label class="line-height-1 blue">
																							...
																							?>
																								<div id="combo">
																									<input name="dari" id="<?=$names;?>" type="radio" class="ace" value="<?=$row['id'];?>" <?=$selCheckCombo?> />
																							...
																							<?php 
																								...
																								?>
																								<div id="remarks">
																									<input name="dari" id="<?=$names;?>" type="radio" class="ace" value="<?=$row['id'];?>" <?=$selCheckR?> />
																									<span class="lbl"> <?=$row['name'];?> </span>
																									<br>
																									<div style="padding-left: 20px" >
																	...
																	<div class="form-group">
																		...
																		<div class="col-xs-9">
																			<select id="selectVer" name="selectVer" style="width: 100%; height: 34px" autofocus required>
																				...
																				<?php $qver = "SELECT * FROM version WHERE stsrec = 'A' ORDER BY id";
															...
															<div class="row">
																<div class="col-xs-12" style="padding-left: 10px">
																	<h4 class="lighter block green">Akun Perkiraan</h4>
																		...
																		<div class="col-xs-2">
																			<label>
											                                    <input type="checkbox" name="auto" id="auto" value="Y" checked/>
														...
														<div class="container col-xs-12 col-sm-12 col-md-12 col-lg-12">
															<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" style="float: left;">
																...
																<div class="form-group">
																	...
																	<div class="col-xs-8">
																		<input type="text" id="wa" name="wa" style="width: 180px" onKeyPress="return goodchars(event, '0123456789', this)" maxlength="15" placeholder="Nomor Whatsapp" autofocus required />
																	</div>
																</div>
																	...
																	<div class="form-group">
																		...
																		<div style="padding-left: 20px" >
																			<select id="selectVer" name="selectVer" style="width: 180px; height: 34px" autofocus required>
																				<option value="">--Pilih Versi--</option>
																				<?php 
																					$qver = "SELECT * FROM version WHERE stsrec = 'A'  ORDER BY id";
																					$rmver = mysql_query($qver) or die(mysql_error());
																					while ($rowV = mysql_fetch_array($rmver)){
		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				.on('finished.fu.wizard', function(e) {
					...
					var data = $('#modal-table #validation-form1').serialize() + '&' +  $('#modal-table #validation-form2').serialize()+'&auto='+$('#auto').val(); 
...
<!-- _________script radio button kode agen______ -->
			...
			$('input[type=radio]').on('click', function(){
				let agen = $('#modal-table #agen');
	    			if (agen.is(':checked')){
	    				...
	    				$('#modal-table #selectAgen-error').remove();
				...
				let combobox = $('#modal-table #combo .ace');
    				if (combobox.is(':checked')){
						...
						$('#modal-table #combo #combobox-error').remove();
	    			}
	    		...
	    		let inputan = $('#modal-table #remarks .ace');
    				if (inputan.is(':checked')){
						...
						$('#modal-table #remarks #inputan-error').remove();
	    			}	
			});
			...
			$('input[type=radio]').on('click', function(){
				let agen = $('#modal-copy-master #agen');
	    			if (agen.is(':checked')){
	    				...
	    				$('#modal-copy-master #selectAgen-error').remove();
				...
				let combobox = $('#modal-copy-master #combo .ace');
    				if (combobox.is(':checked')){
						...
						$('#modal-copy-master #combo #combobox-error').remove();
	    			}
	    		...
	    		let inputan = $('#modal-copy-master #remarks .ace');
    				if (inputan.is(':checked')){
						...
						$('#modal-copy-master #remarks #inputan-error').remove();
	    			}	
			});
						...
						if (record.status == 'successTampil') {
							...
							if (record.used == 'tenggang') {
								...
								html='<div class="alert alert-danger alert-dismissible" role="alert">'+
										...
										'<strong>Warning!!&emsp;</strong>Anda sedang berada dalam <strong>masa tenggang</strong>, mohon selesaikan tagihan anda.... &emsp;&emsp;&emsp;'+
									'</div>';
								$('#message').append(html);
   ...
   //  				if (teman.is(':checked')){
	  ...
	  //   			}	
			...
			function login(used, active, dbname, versi, companyname, begindate, enddate, used, custid) {
				if (active == 'A' && used != 'D') {
