...
define('SW_PROJECT_TITLE', 'SISERP');
...
{
	$db = isset($_SESSION['dbDef']) ? $_SESSION['dbDef'] : 'sis_acc';
define('SW_DB_DRIVER', SW_DB_TYPE);
define('SW_DB_USER', 'root51');
define('SW_DB_PASSWORD', 'Siscom3519');
define('SW_DB_HOST', '192.168.0.219');
define('SW_DB_DATABASE', $db);
}
