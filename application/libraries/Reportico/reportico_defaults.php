    ...
    function reportico_defaults($reportico)
    {
            ...
            */
            ...
            if ( $reportico->pdf_engine == "tcpdf" )
            {
                ...
                $reportico->create_page_header("H1", 1, "{REPORT_TITLE}{STYLE font-weight:bold; border-width: 0 0 0 0; margin: 15px 0px 0px 0px; border-color: #000000; font-size: 18; border-style: solid;padding:5px 0px 5px 0px; height:1cm; background-color: #ffffff; color: #000000; text-align: center}" );
