...
$count = count($data['brandInfo']); 

if($count>0)
{
    for($i=0;$i<$count;$i++)
    {
        $kode = $data['brandInfo'][$i]['KODE'];
		$name = $data['brandInfo'][$i]['NAMA'];
		$aktif = $data['brandInfo'][$i]['AKTIF'];
    }
}
if($aktif == 'N')
{
...
// $cntKode = $this->Mpersediaan_model->cekBrandExists($kode);
// if($cntKode > 0) {
//     $disabled = 'disabled';
// } else {
//     $disabled = '';
        ...
        <div class="col-lg-6 col-sm-8">
            ...
            <div class="row mt-3">
                <div class="col-lg-10">
                    ...
                    <input type="text" class="form-control" name="nama" id="nama" maxlength="10" autocomplete="off" onkeyup="ChangeCase(this)" onKeyPress="return isNumberAlphaDotKey(event)" value="<?= $name ?>">
                </div>
            </div>
            <div class="row">
